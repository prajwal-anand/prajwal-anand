...
My work focuses on SQL-driven ELT transformations, layered warehouse design (RAW → STAGING → CURATED), fact-grain control, cohort modeling, and semantic BI validation.
...
- Time-Series & Segmentation Modeling
...
- Developed a BigQuery analytical warehouse with separated transformation and reporting layers, implementing curated analytical views optimized for BI consumption.
...
Former Program Manager in Customer Support, where I led operational reporting, KPI tracking, and performance optimization initiatives.

My exposure to business metrics and process analytics motivated a deeper technical shift into Analytics Engineering — formalizing SQL-based data modeling, warehouse architecture, and structured ELT workflows across cloud platforms.

Today, I focus on building scalable, analytics-ready data systems that bridge operational data with strategic decision-making.

---

## 📫 Connect With Me

- LinkedIn: www.linkedin.com/in/prajwal-anand-b08a5612a
